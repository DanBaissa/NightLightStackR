...
if (file.exists(netrc) == TRUE || grepl("urs.earthdata.nasa.gov", readLines(netrc)) == TRUE) {
...
files <- c("https://goldsmr4.gesdisc.eosdis.nasa.gov/data/MERRA2/M2T1NXLND.5.12.4/1980/01/MERRA2_100.tavg1_2d_lnd_Nx.19800101.nc4")

# 3. Text file containing links (just an example, replace with your text file location):
# files <- readLines("https://goldsmr4.gesdisc.eosdis.nasa.gov/data/MERRA2/M2T1NXLND.5.12.4/1980/01/MERRA2_100.tavg1_2d_lnd_Nx.19800101.nc4", warn = FALSE)
